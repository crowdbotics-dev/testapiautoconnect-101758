...
## Project Structure
    ...
    ├── testapiautoconnect_101758  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_101758`
...
2. Clone this repo and `cd testapiautoconnect_101758`
